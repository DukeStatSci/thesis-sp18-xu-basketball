...
###Model
A binomial logistic regression was fit to determine what features were important to predicting a made shot. Below is the formula:

$y_{made} \sim \beta_{tri}x_{tri} + \beta_{recip}x_{recip} + ...$

###Results
Network characteristics, although informative in summarizing possessions, were not significant predictors of 
