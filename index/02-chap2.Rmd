...
Currently, the implementation of the model has yet to be completed due to setbacks of incompatible R code. The implementation of this paper will be continued to attempt and understand by the end of next semester.
...
Network modeling of the Duke Men's Basketball dataset 
...
$y_{made} \sim \beta_{tri}x_{tri} + \beta_{recip}x_{recip} + ...$
...
Gudmundsson, J., & Horton, M. (). "Spatio-Temporal Analysis of Team Sports -- A Survey." Retrieved from https://arxiv.org/abs/1602.06994 
                                                                                                                        
                                   
#missing three citations                                                                                 