...
```{r}
made_miss <- G1Q456 %>% filter(`event-descrip` %in% c('missed shot', 'made shot')) %>% filter(`player-id`== "109412")
#okafor = 126162
#jabari: 121033
#quinn cook: 109412
# simple plot using EVENT_TYPE to colour the dots

g <- rasterGrob(fullcourt, interpolate = T, width =.92, height = .92)
ggplot(made_miss, aes(x=ball_y, y=ball_x)) +  annotation_custom(g,  xmin=0, xmax=95, ymin=0, ymax=49) +
...
#240
#which side are the students sitting
#write about biases
--count/compare fractions of shots
